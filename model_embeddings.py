...
class ModelEmbeddings(nn.Module): 
    ...
    def __init__(self, word_embed_size, vocab):
        ...
        self.vocab = vocab
        pad_token_idx = self.vocab.char_pad
    ...
    def forward(self, input):
        ...
        #print("inp size =", list(input.size())
        #max_word_length = input.shape
        [sentence_length, batch_size, max_word_length] = list(input.size())
        
        #print ("max_w_l =", max_word_length)
        ...
        #print("before CNN =", X_reshaped)
        X_conv_out = self.convNN(X_reshaped)
        #print("after CNN =", X_reshaped)
